...
combinations = []
with open('unique_combinations.txt', 'r') as f:
    for line in f:
        if line.strip():
...
with open('packaging_data.csv', 'w', newline='') as f:
...
print(f"Generated realistic values for {len(results)} combinations and saved to packaging_data.csv")
